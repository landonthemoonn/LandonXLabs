...
import { LandonLabsLogoCenter } from "./LandonLabsLogoCenter";
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl px-4 pointer-events-none">
        <GlassCard className="p-8 md:p-12 pointer-events-auto flex flex-col items-center justify-center">
          <motion.div
            ...
            className="relative w-[420px] h-[260px] scale-[0.6] sm:scale-75 md:scale-100 origin-center"
          >
            <LandonLabsLogoCenter />
          </motion.div>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="mt-[-60px] sm:mt-[-40px] md:mt-[-20px] text-xs sm:text-sm md:text-base font-['Space_Grotesk',sans-serif] text-white tracking-[0.3em] uppercase"
          >
